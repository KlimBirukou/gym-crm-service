...
class TraineeStorageInitializerTest {
    ...
    private TraineeStorageInitializer testObject;

    @BeforeEach
    void setUp() {
        testObject = new TraineeStorageInitializer();
        testObject.setObjectMapper(objectMapper);
    }

    @Test
    void load_shouldLoadTrainees_whenFileExistsAndValid() throws IOException {
        ...
        doReturn(TRAINEES).when(objectMapper)
